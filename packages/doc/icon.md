...
警告：<a href="https://developer.mozilla.org/zh-CN/docs/Web/SVG/Attribute/xlink:href">MDN</a>从SVG 2开始不推荐使用。不再建议使用此功能。尽管某些浏览器可能仍支持它，但是它可能已经从相关的Web标准中删除，正在被删除或仅出于兼容性目的而保留。
</blockquote>
